    ...
    <div>
              ...
              <div className="card">
                ...
                <div className="desc">
                  <p>
                    ...
                    <br />
                    Vitae reprehenderit est accusamus tempore hic, perspiciatis
                    culpa <br />
                    similique ipsum itaque aspernatur dolorum maxime harum nihil
                    aliquam <br />
                    tempora consequuntur magni maiores unde.
                  </p>
                </div>
              </div>
              <div className="card">
      ...
      <div className="mission">
        <div className="mission-list">
          ...
          <p className="vis">
            To be a centre of excellence in the provision of high quality heath
            services in Malawi
          </p>
          <h3 className="vision1">MISSION STATEMENT</h3>
          <p className="vis">
            We are fully committed to deliver effective, preventive, promotive,
            currative and rehabilitative health services to all citizens
          </p>
      ...
      <div className="quick">
        ...
        <h6 className="quick1">
          Get fast and reliable quick services from Liwonde private hospital
        </h6>
        <section className="section">
          <div className="box-container">
            <div className="flexbox">
              ...
              <p>
                Pentients and clients can quickly request medical in a single
                click of button and then follow easy steps instruction
              </p>
            </div>
            <div className="flexbox">
              <Image
              ...
              <p>Request ambulance services here click the button below</p>
              <a href="#" className="ambu">
                <button className="ambulance" type="submit">
                  Call Ambulance
                </button>
              </a>
            </div>
            <div className="flexbox">
              ...
              <p>
                Get latest update and news from the various departments of the
                hospital and sign up for medical check ups
              </p>
              <a href="#" className="ambu">
                <button className="ambulance" type="submit">
                  SignUp
        ...
        <h1 className="footer">
          ...
          <div className="important">
            <ul>
              ...
              <li className="sam">
                Address: Liwonde, near puma Firing Station
              </li>
              <li className="sam"></li>
            </ul>
          </div>
