  ...
  const handleSubmit = (e: any) => {
    ...
    emailjs
      ...
      .catch((error) => {
        ...
        alert("email not sent check your connection")
      });
  };
  return (
    <div>
      <section id="box">
        ...
        <Image className="Logo" alt="" src={icon} height={150} width={184} />
        <div>
        <TypeAnimation className="book-head"
                sequence={[
                  "welcome and Book Appointment",
                  1000,
       ...
       <div>
        ...
        <br></br>
        <ul className="koma">
          <li>1.The Form on the right fill the details</li>
          <li>2.Then write us a message</li>
          <li>3.check your email address for response</li>
        </ul>
       </div>
      ...
      <div className="box">
        <form action="" className="email-form" onSubmit={handleSubmit}>
          ...
          <div className="inputBox">
            <textarea
              placeholder="please write us a message"
              id="text-area"
              value={message}
